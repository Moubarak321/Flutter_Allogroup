...
class PopularEventDetail extends StatefulWidget {
  final Map<String, dynamic> produit;

  PopularEventDetail({required this.produit, Key? key}) : super(key: key);

  @override
  _PopularEventDetailState createState() => _PopularEventDetailState();
}

class _PopularEventDetailState extends State<PopularEventDetail> {
        ...
        FirebaseFirestore.instance
          ...
          if (userDoc.exists) {
            ...
            FirebaseFirestore.instance
                ...
                .doc(user?.uid)
                .update({
                  'cartEvent': FieldValue.arrayUnion([userData]),
                })
                .then((_) {})
                .catchError((error) {
            ...
            final newCartData = {
              'cartEvent': [
                userData
              ], // Le premier produit est ajouté au panier.
            };
