...
class HistoriqueAchatEvent extends StatelessWidget {
  User? getCurrentUser() {
          ...
          Expanded(
            child: StreamBuilder(
              ...
              builder: (context, AsyncSnapshot<DocumentSnapshot> snapshot) {
                ...
                if (!userData.containsKey('paiementEvent')) {
                  return Center(
                    child: Text(
                      "Aucun achat",
                      style: TextStyle(
                ...
                final courses = userData['paiementEvent'] as List<dynamic>;
