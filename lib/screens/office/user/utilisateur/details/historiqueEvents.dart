...
class HistoriqueEvent extends StatelessWidget {
  User? getCurrentUser() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Vos commandes de biens',
          ...
          Expanded(
            child: StreamBuilder(
              ...
              builder: (context, AsyncSnapshot<DocumentSnapshot> snapshot) {
                ...
                if (!userData.containsKey('coursesEvent')) {
                  return Center(
                    child: Text(
                      "Aucun achat",
                      style: TextStyle(
                ...
                final courses = userData['coursesEvent'] as List<dynamic>;
